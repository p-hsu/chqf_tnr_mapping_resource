...
const Form = () => {
    return (
        <form className="p-2 m-auto w-full border-2 border-gray-700 border-opacity-50 rounded-md bg-blue-200 bg-opacity-25 shadow-lg">
                ...
                <div className="form-div">
                    <label className="mt-1 ml-1 uppercase text-gray-700 text-xs font-semibold">Status</label>
                </div>
                <div className="form-div">
